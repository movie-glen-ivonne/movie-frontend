...
export default function Admin() {
    ...
    const { user, login, loading, isAuthenticated }: any = useAuth();
    ...
    const handleConfirmEdit = async (updatedUser: User) => {
      ...
      try {
        ...
        if (res.ok) {
          setUsers((prev) =>
            prev?.map((user) => (user.id === updatedUser.id ? updatedUser : user)) || null
          );
          setIsError(false);
  ...
  return (
      <>   
        <div className="m-12 relative flex flex-col h-full text-gray-700 bg-black shadow-md rounded-xl bg-clip-border">
            <div className="relative mx-4 mt-4 overflow-hidden text-white bg-black rounded-none bg-clip-border">
                ...
                <div className="block w-full overflow-hidden md:w-max">
                    <nav>
                    <ul role="tablist" className="relative flex flex-row p-1 rounded-lg bg-white bg-opacity-30">
                        <li role="tab"
                        className="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center bg-transparent cursor-pointer select-none text-white"
                        data-value="all">
                        <div className="z-20 text-inherit">
                            &nbsp;&nbsp;All&nbsp;&nbsp;
                        </div>
                        <div className="absolute inset-0 z-10 h-full bg-black rounded-md shadow"></div>
                        </li>
                        <li role="tab"
                        className="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center bg-transparent cursor-pointer select-none text-white"
                ...
                {users?.map((data, index) => (
                    ...
                    <td className="p-4 border-b border-blue-gray-50">
                        ...
                        <button
                            ...
                            className="text-white hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-1 text-center dark:bg-netflixRed dark:text-white dark:hover:bg-red dark:focus:ring-blue-800"
                            >
                            Delete User
                        </button>
                        </div>
