      ...
      <div className="w-full p-1 shadow-md rounded-xl rounded-bl-none rounded-br-none">
        <div className="flex p-2 align-middle items-center">
          ...
          <div className="border rounded-full border-black p-1/2">
            <Image
                    src={`https://ui-avatars.com/api/?name=${room_name.toUpperCase()}&background=random`}
        ...
        {messages.map((message: any) => (
          ...
          >
            {message.senderId == id ? (
              ...
              <Image
                    src={`https://ui-avatars.com/api/?name=${message.username.toUpperCase()}&background=random`}
            ...
            <div
                className={`w-full flex flex-col p-2 ${
                    message.senderId == id ? 'items-end' : 'items-start'
                }`}
                >
                ...
                >
                    <div className="text-gray-700 dark:text-gray-200">{message.text}</div>
                </div>
            </div>
          </div>
        ))}
